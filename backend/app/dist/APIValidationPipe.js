...
let APIValidationPipe = class APIValidationPipe {
    async transform(value, { metatype }) {
        ...
        if (errors.length > 0) {
            ...
            throw new common_1.BadRequestException(errorProps);
        }
        return value;
    }
    toValidate(metatype) {
...
APIValidationPipe = __decorate([
    common_1.Injectable()
], APIValidationPipe);
exports.APIValidationPipe = APIValidationPipe;
//# sourceMappingURL=APIValidationPipe.js.map